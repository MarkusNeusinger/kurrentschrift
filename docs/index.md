...
| [admin-redesign.md](proposals/admin-redesign.md) | Der Admin auf der grünen Wiese: Ist-Befund aus dem Browser, drei Optionen (Evolution · Hand-zentriert · Aufgaben-zentriert) mit Information und Knöpfen je Fläche, die Eigenhand-Statistik je Buchstabe und Übergang, Nutzungsszenarien, der beantwortete Rückfragen-Katalog (§4.5) und der Bauplan der gewählten Form (§15) | teil-umgesetzt — Katalog am 2026-09-18 entschieden (A zuerst, C-Bausteine Phase 4, B punktuell, Phase 5 parallel); **Phase 0 und Phase 1 sind ausgeliefert** (neun + acht PRs gemergt, der Nachzug #628 mit #633; offen nur der Prod-Datenschritt V1), jede Browser-Prüfung der Phase 1 lief auf dem Wegwerf-Stack mit synthetischen Daten (§15.4); **Phase 2 (Tintentreue + Nachfahren) hat begonnen** — die nur lesende Erkundung ist gelaufen und hat 22 Stellen des Docs als falsch belegt (21 hier berichtigt, die 22. schon mit #632), Runde 1 ihrer Fragen ist am 2026-09-20 entschieden (§4.7), der Schnitt in dreizehn PRs steht in §15.6, gemergt ist davon nichts; Phase 5 wartet auf V1, FM1–FM6 und den Lese-Sweep; offene Geschmacksfragen der Phasen 0/1 in §15.5 |
