...
| [verfahren-kette.md](reference/verfahren-kette.md) | Kette: Steckbrief, Stand v5 (Wächter-Stack), seit A45 Baustein statt Standard, Arm-Ledger ①–⑨ / K-A…K-E2 / K0-Z / K0-S / K-D | Wenn ein Kette-Arm gemessen, adoptiert oder zitiert wird |
...
| [verfahren-tintenpfad.md](reference/verfahren-tintenpfad.md) | Tintenpfad (Tinte zuerst, Buchstaben danach): Steckbrief, Stand **adoptiert — Standard-Folger** (A45, `sep12`), Ledger #591 · Arme · Kombinationen · Adoption, offene Blöcke | Wenn ein Tintenpfad-Arm gemessen, adoptiert oder zitiert wird |
...
| [admin-redesign.md](proposals/admin-redesign.md) | Der Admin auf der grünen Wiese: Ist-Befund aus dem Browser, drei Optionen (Evolution · Hand-zentriert · Aufgaben-zentriert) mit Information und Knöpfen je Fläche, die Eigenhand-Statistik je Buchstabe und Übergang, Nutzungsszenarien, der beantwortete Rückfragen-Katalog (§4.5) und der Bauplan der gewählten Form (§15) | teil-umgesetzt — Katalog am 2026-09-18 entschieden (A zuerst, C-Bausteine Phase 4, B punktuell, Phase 5 parallel); **Phase 0 und Phase 1 sind ausgeliefert** (neun + acht PRs gemergt, der Nachzug #628 mit #633; offen nur der Prod-Datenschritt V1), jede Browser-Prüfung der Phasen 1 und 2 lief auf dem Wegwerf-Stack mit synthetischen Daten (§15.4, §15.6); **Phase 2 (Tintentreue + Nachfahren) ist gebaut** — alle neun Fragen A–I sind am 2026-09-20 entschieden (§4.7, H gegen die Empfehlung), alle dreizehn PRs sind gemergt; offen bleibt aus PR 13 die Kalibrier-RUNDE (das Instrument steht, die Runde braucht 30 unter Format 2 gemessene Kästen, und heute misst nur der Folger — `pfad --messen` für gezeichnete Bahnen ist nicht gebaut), die Ampel steht also ungeeicht; Phase 5 wartet auf V1, FM1/FM2/FM4/FM5/FM6 (FM3 ist entschieden) und den Lese-Sweep; offene Geschmacksfragen in §15.5 (Phase 0/1) und §15.7 (Phase 2, mit den drei Autor-Schritten) |
| [freigabe-maschine.md](proposals/freigabe-maschine.md) | Das Zielbild für die WIEDERKEHRENDE Auslieferung einer wachsenden Hand: create-only Stände im Varianten-Band, der Auslieferungs-Zeiger (Quelle → Hand → Stand), Regression je Hand, Änderungsprotokoll der Applies, Rollback; der Bandschnitt für den Schema-PR von Phase 5 und sechs Rückfragen, von denen FM3 (Rückhaltemenge) seit 2026-09-20 entschieden ist | offen — nichts gebaut (Autor-Entscheid Q24 i, 2026-09-18) |
...
| [eigenhand-erfassung.md](proposals/eigenhand-erfassung.md) | Die eigene Hand erfassen — und seit 2026-09-07 als künftige **Auslieferungshand**: Wortvorrat → Streifenplan → Bögen → Siebung → Streifenkartei → Bestand, mit dem **Streifen-Befund** als Sauberkeits-Schleife (§7.3) | teil-umgesetzt (Phasen 1–4h) |
