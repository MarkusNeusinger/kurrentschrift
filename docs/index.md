...
| [admin-redesign.md](proposals/admin-redesign.md) | Der Admin auf der grünen Wiese: Ist-Befund aus dem Browser, drei Optionen (Evolution · Hand-zentriert · Aufgaben-zentriert) mit Information und Knöpfen je Fläche, die Eigenhand-Statistik je Buchstabe und Übergang, Nutzungsszenarien, der beantwortete Rückfragen-Katalog (§4.5) und der Bauplan der gewählten Form (§15) | teil-umgesetzt — Katalog am 2026-09-18 entschieden (A zuerst, C-Bausteine Phase 4, B punktuell, Phase 5 parallel); **Phase 0 und Phase 1 sind ausgeliefert** (neun + acht PRs gemergt, der Nachzug #628 mit #633; offen nur der Prod-Datenschritt V1), jede Browser-Prüfung der Phasen 1 und 2 lief auf dem Wegwerf-Stack mit synthetischen Daten (§15.4, §15.6); **Phase 2 (Tintentreue + Nachfahren) ist geliefert bis auf zwei PRs** — alle neun Fragen A–I sind am 2026-09-20 entschieden (§4.7, H gegen die Empfehlung), elf der dreizehn PRs sind gemergt, offen bleiben `pfad --spans` (die benannte Ausnahme) und die Kalibrierung (nicht baubar ohne gezeichnete Bahnen), die Ampel steht also ungeeicht; Phase 5 wartet auf V1, FM1/FM2/FM4/FM5/FM6 (FM3 ist entschieden) und den Lese-Sweep; offene Geschmacksfragen in §15.5 (Phase 0/1) und §15.7 (Phase 2, mit den drei Autor-Schritten) |
