...
| [`reference/verfahren.md`](reference/verfahren.md) samt den vier Verfahrensseiten (`verfahren-kette` · `verfahren-lotse` · `verfahren-inksight` · `verfahren-nullprobe`) | jedem §14-Eintrag, der einen Arm oder eine Stufe eines Duell-Verfahrens misst (adoptiert oder verworfen) — Ledger-Zeile im selben PR; bei Adoption zusätzlich „Aktueller Stand" der betroffenen Seite und die Stand-Spalte der Übersicht |
