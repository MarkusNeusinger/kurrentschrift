...
| [tintenfolger.md](proposals/tintenfolger.md) | Die Wortbahn-Kampagne: Referenzsatz, Routen-Duell, Optimierungsplan §7, Rettungswege §7.9, offene Arme §7.11; Wellen-Basis seit `sep12` als Baustein im Repo (Vorgabe AUS, §7.9) | teil-umgesetzt (Duell gemessen) |
