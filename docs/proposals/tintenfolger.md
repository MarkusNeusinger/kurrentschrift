...
| **Rückhalt-Ziehung vor dem Scan von S0182–S0188** | §14 „… `sep24b`", „Trainingssatz `sep20`" | Stufe (b) verbraucht nur `practice`-Kästen; welche das sind, sagt erst die Ziehung | offen: `training_set --draw <Schlüssel>`, dann B0002 |
