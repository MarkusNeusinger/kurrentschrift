...
| **Die zwei J4-Konversionen** | §14 „Übergänge J4/J4b `sep02`", §7.9 | der Naht-Knick ist beseitigbar, aber `dconn` kann per Konstruktion nicht darüber urteilen | offen: (1) nur die Ankunftsseite als eigener Arm · (2) SENSOR zuerst — eine ausdehnungs-normierte Formdistanz bauen und einfrieren, dann neu vorregistrieren. Der dritte Weg der §7.9-Zeile **läuft**: die humanbench-Wortrunde ist vorregistriert und gebaut (§14 „Übergänge J4 `sep04`"), das Urteil liegt beim Autor |
