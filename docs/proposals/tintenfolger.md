...
| L2 | ß-Klasse des Lotsen (Bögen-Strich ohne Stamm-Durchstoß, Sporn-Ritte) | Autopsie nach L1 (L1 kann die Stamm-Kreuzung schon liefern); dann eigener Arm | Lotse | durch v0.9 weitgehend gedeckt; **Rest-Autopsie erledigt `aug19`** (§14 „L2-Rest-Autopsie"): die muß-Klasse ist ORDNUNGS-dominiert — der VERBUNDENE ü-Deckbogen sitzt bei der Hand am Wortende, bei der Komposition nach der u-Gruppe; Referenz-Eigenschaft (`marks_uncertain`-Klasse), deckelt alle Routen, Optionen beim Owner |
