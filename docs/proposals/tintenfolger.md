...
| **Die vier J6-Konversionen** | §14 „Übergänge J6 `sep06`", §7.9 | die Naht ist an beiden Enden zu (Abgang 2,67° → 0,01°, Ankunft 10,80° → 0,01° über 240 Nähte, Platzierung unberührt) — und die Rechnung steht auf drei Zwei-Buchstaben-Übungen, weil der Verbinder dort 33° in 0,3 xh wegdrehen muss und sich neben die eigene Tinte des `d` legt | offen: (1) **J6b** post-hoc schon gemessen (Gate (c) grün, aber Arkade→Arkade behält seine 18,57° über 24 Joins) — Adoption braucht frische Pre-Reg · (2) J6c, den Verbinder-Anteil über seinen ganzen Bogen verteilen · (3) den Deckel je Klasse aus den Vorkommen messen · (4) die identische Punktmenge für den Unstetigkeits-Sensor, ohne die sein +12/+11 nicht zurechenbar ist. **Runde 7 liegt gebaut** und lizenziert bei ≥ 60 % J6b, nicht den Default |
