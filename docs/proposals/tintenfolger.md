...
| **Stufe 3 gezielt: R-gate + R-split** (Streifen-Eingabe) | §14 „Folger-Eingabe-Leiter `sep24`", §7.9 | A3 hebt die Hand 7 von 7 und reißt den Platten-Wächter (−0,0034 am Medianwort); sy liest auf der Platte 0,57–1,37 | **vorregistriert** (§14 „… `sep24b`"): (a) offen, (b) wartet auf Ziehung und S0182–S0188 |
