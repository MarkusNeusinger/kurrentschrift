...
| **Der Mittelachsen-Term (R4) — die Feder aus der EVIDENZ herausrechnen** | §14 „Kette R3 `sep07`" (Konversion 4), von „Kette R3c `sep07`" auf den ersten Platz gehoben | **Beide Klammern sind gemessen und zeigen auf dieselbe Ursache.** Hinter dem Solve trifft die Bedingung ihr Ziel und zerstört die Glätte (R3: 107/108 offen, +1 626 Knicke); IM Solve hält sie die Glätte und trifft ihr Ziel nur, wo es schon getroffen war (R3c: Knicke 2 296 → 2 258, aber 0 Bewegung an den 31 zugelaufenen Schleifen). Der gemeinsame Nenner ist der Tinten-Term, der an einer verschmolzenen Stelle selbst auf der Klumpenachse liegt — solange das Abstandsfeld die Feder nicht herausrechnet, argumentiert jede Bedingung GEGEN die Evidenz | offen, eigene Pre-Reg; Eichung liegt vor: 156 Zahlen aus R3c, 106 aus R3 |
