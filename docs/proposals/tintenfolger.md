...
| **Chart-Saat als Default** | §14 „Laufform LF15 `sep06`" | sie ist der einzige gemessene Ernte-Fixpunkt, aber ihre Übernahme leitet 8 von 21 Zeilen um mehr als 0,03 xh neu ab — ein Re-Baseline-Write, und der ist Autorensache | offen: Ja/Nein zur Chart-Saat als Ernte-Default, mit den Kosten daneben (9 Vorkommen, `Z` unter dem Beleg-Boden). Bis dahin gilt die Regel „zweimal ernten" vor jedem Laufform-Write |
