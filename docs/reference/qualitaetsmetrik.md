...
beide seit 2026-09-04 in [`messjournal.md`](messjournal.md).
...
## 14. Tintenfolger-Bench: ausgezogen nach `messjournal.md`

**Seit 2026-09-04 steht §14 in einer eigenen Datei:**
[`messjournal.md`](messjournal.md) — Wort für Wort dieselbe Sektion, mit
denselben Überschriften und denselben Ankern, nur in einer anderen Datei.
Der Grund ist Umfang: §14 trug 7 366 Zeilen und damit zwei Drittel dieser
Datei, sodass jede Frage nach einer Metrik-Regel das ganze Journal
mitgeladen hat. `qualitaetsmetrik.md` trägt ab jetzt die **Regeln**
(§1–§13 und §15), das Messjournal die **Läufe** und
[`messjournal-archiv.md`](messjournal-archiv.md) die abgeschlossenen
Arme.

Einstieg dort ist das Register: eine Zeile je Abschnitt mit Datum, Route,
Typ · Verdikt und Befund. Zitate der Form „§14 «Titel»“ bleiben gültig;
sie meinen ab jetzt die Sektion in
