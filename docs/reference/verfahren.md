...
| **Lotse** | [`verfahren-lotse.md`](verfahren-lotse.md) | **v0.17** (`aug20`, Reservierungs-Veto) — Zahlen nachgemessen `sep04` auf derselben Wurzel wie die Kette: dtw **0,056080** med · p90 0,1155 · aiou 0,7527 · `cross_spurious` 1 · `retrace_missing` 5. Die frühere Zeile nannte 0,0545 / 0,1164 / 0,740 — 0,0545 war eine Transkription (`laden`, Rang 9 statt des Medians 0,058522) und stand auf einer drei Neu-Exporte alten Wurzel, §14 „Lotse-Sprung `sep04`" | 2026-08-20 (Zahlen 2026-09-04) |
