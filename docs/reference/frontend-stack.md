...
- `sections/admin/eigenhand/` — der Bestand einer HAND (nicht einer Vorlage)
  ...
  Hand wieder freigegeben. Der Streifen-Filter liegt seit dem Split in der
