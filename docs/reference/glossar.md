...
Über eine ganze Hand GEZÄHLT heißt sie **Tintentreue-Verteilung** (Stufe 1,
seit 2026-09-25 in der Statistik-Ansicht der Eigenhand,
`app/src/sections/admin/eigenhand/tintentreueVerteilung.ts`): je Stufe die Zahl
der Kästen, bei den schlechten Stufen nach benennendem Sensor, beim Grau
nach Grund, wahlweise je Fassung — gezählt, nie verrechnet, und nie über
Hände verglichen, weil die Schwellen je Hand gelten.
