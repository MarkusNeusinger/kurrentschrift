...
- **The Saat-Korrespondenz: a measured way from the decoded path to a
  ...
  (default `fit`, unchanged and byte-identical, and `--apply` refuses the
  arm): author decision A48, way 1 of the three in `tintenfolger.md` §7.11,
  measured and filed as „Laufform A48 `sep13`" in `messjournal.md` §14.
