...
## Run the docs gate before the PR

```bash
uv run python -m tools.docs_budget check     # the gate (CI job „Docs-Budget")
uv run python -m tools.docs_budget report    # what each reading path costs today
```
