...
# (S 1.76→0.30, O 1.98→0.48), NOT the ductus end: the crest stays fully
...
CAP_RESTART_BASES = frozenset({"S", "O", "K", "P"})
CAP_EXIT_MAX_Y = 0.55
# RESTART-class joins (S/O/K/P only) rise monotonically on the plates
