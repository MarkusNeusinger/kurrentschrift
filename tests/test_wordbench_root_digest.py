"""Unit tests for the word bench's fixture-root identity (tools/wordbench/run.py).
...
from tools.wordbench.run import build_parser, check_expected_roots, page_hash_problems, root_digest
