...
| Tintenfolger measurement rounds | `/verify-trace` (BLAS pinned, same stack but one knob; afterwards the §14 entry — inserted BEFORE `## 15.`, §14 is a closed section — plus its register row and the ledger line) |
